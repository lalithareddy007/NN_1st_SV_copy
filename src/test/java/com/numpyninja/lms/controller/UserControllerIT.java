...
public class UserControllerIT {
    ...
    public void testGetUserByProgramBatch() throws Exception {
        final MvcResult mvcResult = mockMvc.perform(get("/lms/users/programBatch/" + 2).contextPath("/lms")
                        .header("Authorization", "Bearer " + token)
                        .contentType("/application/json"))
                .andReturn();
    ...
    @Test
    @Order(20)
    public void testGetUsersByProgramId() throws Exception {
        final MvcResult mvcResult = mockMvc.perform(get("/lms/users/programs/" + 2).contextPath("/lms")
                        .header("Authorization", "Bearer " + token)
                        .contentType("application/json"))
                .andReturn();
